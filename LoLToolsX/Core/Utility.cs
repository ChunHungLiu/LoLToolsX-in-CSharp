...
namespace LoLToolsX.Core
{
    static class Utility
    {
        ...
        public static System.Drawing.Image ResizeImage(System.Drawing.Image imageToResize, int width, int height)
        {
        	...
        	using (var graphics = System.Drawing.Graphics.FromImage(destImage))
        	{
        		...
        		using (var wrapMode = new System.Drawing.Imaging.ImageAttributes())
        		{
        			...
        			graphics.DrawImage(imageToResize, destRect, 0, 0, imageToResize.Width, imageToResize.Height, System.Drawing.GraphicsUnit.Pixel, wrapMode);
        		}
        	}
        	return destImage;
        }
        
        public static void CurToTga()
        {
